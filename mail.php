...
$site_top = "http://examplee-com.check-xserver.jp/index.html";
...
URL: http://examplee-com.check-xserver.jp/index.html
──────────────────────
...
<?php
		...
		function copyright()
		{
			echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://examplee-com.check-xserver.jp/index.html" target="_blank">- Copyright 2023 パーソナルジムSANTE -</a>';
		}
		//----------------------------------------------------------------------
		//  関数定義(END)
		//----------------------------------------------------------------------
